...
#define __LEAG37_QWERTY_33THUMB_LEFT__ LT(MEDIA, KC_TAB), LT(NAV, KC_ESC), LT(MOUSE, KC_SPACE)
#define __LEAG37_QWERTY_33THUMB_RIGHT__ LT(SYMBOL, KC_ENT), LT(NUMBER, KC_BSPC), LT(FUNC, KC_DEL)
#define __LEAG37_QWERTY_32THUMB_LEFT__ LT(MEDIA, KC_TAB), LT(NUM, KC_BSPC), LT(MOUSE, KC_ENT)
...
#define __LEAG37_MID_LEFT_3x6_EXT__ KC_LPRN
#define __LEAG37_MID_RIGHT_3x6_EXT__ KC_RPRN
#define __LEAG37_BOT_LEFT_3x6_EXT__ KC_LT
#define __LEAG37_BOT_RIGHT_3x6_EXT__ KC_GT
