...
#define LEAG37_DEFINE_OVERRIDES const key_override_t *key_overrides[] = {&key_override_lparen, &key_override_rparen, &key_override_comma, &key_override_period, &key_override_unds, &key_override_enter};
